...
class DesignSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('designs')->insert([
            ...
            ['design' => "Nguyên khối", 'material' => "Nhựa, mặt lưng bằng nhôm", 'size' => "Dài 158.2 mm - Ngang 77.9 mm - Dày 7.3 m", 'weigth' => "188 g"],
            ['design' => "Nhựa", 'material' => "Nhựa", 'size' => "Dài 158.2 mm - Ngang 77.9 mm - Dày 7.3 m", 'weigth' => "188 g"],
        ]);
    }
}
