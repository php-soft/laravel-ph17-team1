...
Route::get('products/dtdd/gia/duoi1trieu', 'ProductController@indexByPriceDown1M')->name('duoi1trieu');
Route::get('products/dtdd/gia/tu1den3trieu', 'ProductController@indexByPrice1to3M')->name('tu1den3trieu');
Route::get('products/dtdd/gia/tu3den7trieu', 'ProductController@indexByPrice3to7M')->name('tu3den7trieu');
Route::get('products/dtdd/gia/tu7den10trieu', 'ProductController@indexByPrice7to10M')->name('tu7den10trieu');
Route::get('products/dtdd/gia/tu10den15trieu', 'ProductController@indexByPrice10to15M')->name('tu10den15trieu');
Route::get('products/dtdd/gia/tren15trieu', 'ProductController@indexByPriceUp15M')->name('tren15trieu');
Route::get('products/dtdd/loai/smart-phone', 'ProductController@indexBySmartPhone')->name('smartphone');
Route::get('products/dtdd/loai/classic-phone', 'ProductController@indexByClassicPhone')->name('classicphone');
...
->name('duoi3MP');
Route::get('products/dtdd/camera/tu3den5MP', 'ProductController@indexByCamera3to5MP')->name('tu3den5MP');
Route::get('products/dtdd/camera/tu5den8MP', 'ProductController@indexByCamera5to8MP')->name('tu5den8MP');
Route::get('products/dtdd/camera/tu8den12MP', 'ProductController@indexByCamera8to12MP')->name('tu8den12MP');
Route::get('products/dtdd/camera/tren12MP', 'ProductController@indexByCameraUp12MP')->name('tren12MP');
Route::get('products/dtdd/chatlieu/kimloainguyenkhoi', 'ProductController@indexByDesignUnibodyMetal')->name('kimloainguyenkhoi');
Route::get('products/dtdd/chatlieu/nhuavakimloai', 'ProductController@indexByDesignPlasticMetal')->name('nhuavakimloai');
Route::get('products/dtdd/chatlieu/kimloaivakinhcuongluc', 'ProductController@indexByDesignMetalGlass')->name('kimloaivakinhcuongluc');
