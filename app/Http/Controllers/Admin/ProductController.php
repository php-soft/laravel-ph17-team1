...
class ProductController extends Controller
{
    public function index()
    {
      ...
      return View('admin.products.index',compact('products', 'product_gets', 'colors', 'manus', 'cates', 'fronts', 'backs', 'batteries', 'connects', 'memories', 'designs', 'operas', 'screens', 'utilities', 'colors_add', 'manus_add', 'cates_add', 'fronts_add', 'backs_add', 'batteries_add', 'connects_add', 'memories_add', 'designs_add', 'operas_add', 'screens_add', 'utilities_add'));
    }
    ...
    public function newProduct(Request $request)
    {
        $this->validate($request, [
                ...
                'sale_price' => 'regex:/[0-9]/|max:30000000',
                ...
                'sale_price.regex' => 'Giá KM phải là số',
                'sale_price.max' => 'Giá KM tối đa là 30 triệu đồng',
    ...
    public function editProduct($id)
    {
      ...
      return View('admin.products.edit', compact('product', 'colors', 'manus', 'cates', 'fronts', 'backs', 'batteries', 'connects', 'memories', 'designs', 'operas', 'screens', 'utilities'));
    }
